...
import com.xuhongxu.LibrarySeat.SeatLayoutItem
...
class SeatLayoutItemRecycleAdapter(val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ItemHolder {
        val itemView = LayoutInflater.from(parent!!.context)
                .inflate(R.layout.grid_item_seat_layout, parent, false)
    ...
    class ItemHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        ...
        val button = itemView!!.findViewById<Button>(R.id.name_button)
    }
}
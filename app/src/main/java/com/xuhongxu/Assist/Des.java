...
class Des {
     ...
     */
    static String strEnc(String data, String firstKey, String secondKey,
                         String thirdKey) {

        int leng = data.length();
        String encData = "";
        List<int[]> firstKeyBt = null;
        List<int[]> secondKeyBt = null;
        List<int[]> thirdKeyBt = null;
        int firstLength = 0, secondLength = 0, thirdLength = 0;
        if (firstKey != null && !Objects.equals(firstKey, "")) {
            firstKeyBt = getKeyBytes(firstKey);
            firstLength = firstKeyBt.size();
        }
        if (secondKey != null && !Objects.equals(secondKey, "")) {
            secondKeyBt = getKeyBytes(secondKey);
            secondLength = secondKeyBt.size();
        }
        if (thirdKey != null && !Objects.equals(thirdKey, "")) {
        ...
        if (leng > 0) {
            if (leng < 4) {
                int[] bt = strToBt(data);
                int[] encByte = null;
                if (firstKey != null && !Objects.equals(firstKey, "") && secondKey != null
                        && !Objects.equals(secondKey, "") && thirdKey != null
                        && !Objects.equals(thirdKey, "")) {
                    int[] tempBt;
                    int x, y, z;
                    tempBt = bt;
                ...
                for (i = 0; i < iterator; i++) {
                    ...
                    if (firstKey != null && !Objects.equals(firstKey, "") && secondKey != null
                        ...
                        if (firstKey != null && !Objects.equals(firstKey, "")
                                && secondKey != null && !Objects.equals(secondKey, "")) {
                            int[] tempBt;
                            int x, y;
                            tempBt = tempByte;
                            for (x = 0; x < firstLength; x++) {
     ...
     */
    static String strDec(String data, String firstKey, String secondKey,
                         String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List<int[]> firstKeyBt = null;
        ...
        for (i = 0; i < iterator; i++) {
            ...
            int[] decByte = null;
            if (firstKey != null && !Objects.equals(firstKey, "") && secondKey != null
                    && !Objects.equals(secondKey, "") && thirdKey != null && !Objects.equals(thirdKey, "")) {
                int[] tempBt;
                int x, y, z;
                tempBt = intByte;
                for (x = thirdLength - 1; x >= 0; x--) {
                    assert thirdKeyBt != null;
                    tempBt = dec(tempBt, thirdKeyBt.get(x));
                }
                for (y = secondLength - 1; y >= 0; y--) {
                    assert secondKeyBt != null;
                    tempBt = dec(tempBt, secondKeyBt.get(y));
                }
                for (z = firstLength - 1; z >= 0; z--) {
                    assert firstKeyBt != null;
    ...
    private static List<int[]> getKeyBytes(String key) {
        ...
        if (remainder > 0) {
            ...
            keyBytes.add(i, strToBt(key.substring(i * 4, leng)));
        }
        return keyBytes;
    }
